"""Update timefrequency enum.

Revision ID: e9ef0415da38
Revises: 8b522e11b6a4
Create Date: 2024-10-22 06:27:10.157664
...
def upgrade():
    ...
    sa.Column('frequency', sa.Enum('WEEKLY', 'MONTHLY', 'YEARLY', 'ONE_OFF', name='timefrequency'), nullable=False),
