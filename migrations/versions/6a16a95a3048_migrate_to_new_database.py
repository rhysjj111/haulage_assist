...
Revision ID: 6a16a95a3048
Revises: 
Create Date: 2024-08-26 15:01:18.657584
...
def upgrade():
    ...
    sa.Column('make', sa.String(length=15), nullable=False),
    ...
    sa.Column('fuel_card_name', sa.String(length=20), nullable=False),
